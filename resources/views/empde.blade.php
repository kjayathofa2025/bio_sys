...
@endif
        <form name = "LeaveDe" method="post" action="/add-cuscomp" style="text-align:center;">
          <div>
     ...
     <br>
       ...
       <br>
  		<label  style ="margin-left:320px;">MOBILE NO</label>
      ...
      <br>
        ...
        <div style ="margin-left:570px;float:centre;">    
			  <button type="submit" id ="Submit" style ="color:green" >SUBMIT</button>
		    <button type="submit" id ="Exit" style ="color:red" onclick="callProcedureForWindowsclose() ">EXIT</button>
        </div>
        <!--blade syntax -->
        @csrf
		 </form>
